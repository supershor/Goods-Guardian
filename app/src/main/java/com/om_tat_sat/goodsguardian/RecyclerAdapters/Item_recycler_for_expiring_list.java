...
import com.om_tat_sat.goodsguardian.RecyclerviewInterface_for_expiring;
import com.om_tat_sat.goodsguardian.Utils;
import com.om_tat_sat.goodsguardian.model.Items_holder;

import java.util.ArrayList;

public class Item_recycler_for_expiring_list extends RecyclerView.Adapter<Item_recycler_for_expiring_list.ViewHolder>{
    ArrayList<Items_holder>arrayList;
    private final RecyclerviewInterface_for_expiring RecyclerviewInterface_for_expiring;
    Context context;
    public String curr_date="";
    int thing;
    int arr_index=0;

    public Item_recycler_for_expiring_list(ArrayList<Items_holder> arrayList, Context context, RecyclerviewInterface_for_expiring RecyclerviewInterface_for_expiring, String curr_date, int thing,int arr_index) {
        this.arrayList = arrayList;
        this.arr_index=arr_index;
        this.thing=thing;
        this.curr_date=curr_date;
        this.RecyclerviewInterface_for_expiring=RecyclerviewInterface_for_expiring;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ViewHolder viewHolder=new ViewHolder(view,RecyclerviewInterface_for_expiring);
        return viewHolder;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imageView;
        public ViewHolder(@NonNull View itemView,RecyclerviewInterface_for_expiring RecyclerviewInterface_for_expiring) {
            super(itemView);
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (RecyclerviewInterface_for_expiring!=null){
                        int position=getAdapterPosition();
                        if ((position!=RecyclerView.NO_POSITION)){
                            RecyclerviewInterface_for_expiring.onclick(position,4,arr_index);
                        }
                    }
                }
            });
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (RecyclerviewInterface_for_expiring!=null){
                        int position=getAdapterPosition();
                        if ((position!=RecyclerView.NO_POSITION)){
                            RecyclerviewInterface_for_expiring.onclick(position,2,arr_index);
                        }
                    }
                }
            });
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (RecyclerviewInterface_for_expiring!=null){
                        int position=getAdapterPosition();
                        if ((position!=RecyclerView.NO_POSITION)){
                            RecyclerviewInterface_for_expiring.onclick(position,1,arr_index);
                        }
                    }
                }
            });
            edit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (RecyclerviewInterface_for_expiring!=null){
                        int position=getAdapterPosition();
                        if ((position!=RecyclerView.NO_POSITION)){
                            RecyclerviewInterface_for_expiring.onclick(position,3,arr_index);
                        }
                    }
                }
            });
